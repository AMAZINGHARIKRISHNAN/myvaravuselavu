...
export default function FloatingActionButton({ onClick, icon, label }) {
  ...
  return (
    // Portalled: pages sit inside a wrapper the route transition animates with
    // a transform, which would otherwise anchor this to the bottom of the
    // scrolling content instead of the corner of the screen.
    <Portal>
      <button
        type="button"
        onClick={handleClick}
