...
export default class ErrorBoundary extends Component {
  ...
  render() {
    ...
    return (
      <div className="min-h-svh flex flex-col items-center justify-center gap-4 bg-gray-50 px-6 text-center dark:bg-neutral-950">
        ...
        <div>
          <h1 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Something went wrong</h1>
